  ...
  return (
    <div className="bg-white rounded-lg shadow hover:shadow-lg transition overflow-hidden">
      {book.cover_image_url ? (
        <img src={book.cover_image_url} alt={book.title} className="w-full h-48 object-cover object-top" />
      ) : (
      ...
      <div className="p-6">
        <h4 className="text-lg font-semibold mb-2 line-clamp-1" title={book.title}>{book.title}</h4>
